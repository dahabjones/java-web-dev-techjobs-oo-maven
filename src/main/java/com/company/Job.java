...
public class Job {
    ...
    // TODO: add two constructors - one to initialize a unique ID and a second to initialize the other five fields. The second constructor should
    //  also call the first in order to initialize the 'id' field
